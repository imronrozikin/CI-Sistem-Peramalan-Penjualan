                                    ...
                                    <div class="all-form-element-inner">
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="c_produk" value="<?php echo $produk_data->c_produk ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="merk" value="<?php echo $produk_data->merk ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="tipe" value="<?php echo $produk_data->tipe ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="number" min=0 class="form-control" name="harga" value="<?php echo $produk_data->harga ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="number" min=0 class="form-control" name="stok" value="<?php echo $produk_data->stok ?>" />
