            ...
            <div class="col-lg-12">
                <div class="breadcome-list shadow-reset">
                    ...
                    <ul class="breadcome-menu">
                        ...
                        <li><span class="bread-blod">Update Persediaan</span>
                    </ul>
                </div>
            </div>
        </div>
                                    ...
                                    <div class="all-form-element-inner">
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="date" class="form-control" name="tgl" value="<?php echo $persediaan_data->tgl == "" ? date("Y-m-d") : $persediaan_data->tgl ?>" value="<?php echo date("Y-m-d") ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="nomer" value="<?php echo $persediaan_data->nomer == "" ? $kode : $persediaan_data->nomer ?>" readonly/>
                                        ...
                                        <hr>
                                        <?php $no = 0; $p=0;
                                         foreach ($this->db->query("SELECT detailpersediaan.id AS idtrans, detailpersediaan.*, produk.* FROM `detailpersediaan` INNER JOIN produk ON detailpersediaan.fk_produk = produk.id where fk_persediaan = '$persediaan_data->id'")->result() as $key => $value) : ?>
