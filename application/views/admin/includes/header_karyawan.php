            ...
            <div class="row">
                <div class="col-lg-2 col-md-5 col-sm-6 col-xs-12">
                    <div class="admin-logo">
                        <a href="#"><img src="<?php echo base_url('template/'); ?>img/logo/log.png" alt="" />
                        </a>
                    </div>
                </div>
                <div class="col-lg-7 col-md-5 col-sm-0 col-xs-12">
                    <div class="header-top-menu">
                        <ul class="nav navbar-nav mai-top-nav">
                            ...
                            <li class="nav-item"><a href="<?php echo base_url('Produk') ?>" class="nav-link">Produk</a>
                            </li>
                            <li class="nav-item"><a href="<?php echo base_url('Persediaan') ?>" class="nav-link">Persediaan</a>
                            </li>
                             <li class="nav-item"><a href="<?php echo base_url('Transaksi') ?>" class="nav-link">Transaksi</a>
                            </li>
                        ...
                        <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                ...
                                <div role="menu" class="author-message-top dropdown-menu animated flipInX">
                                    ...
                                    <ul class="message-menu">
                                        <li>
                                            <a href="#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('template/'); ?>img/message/1.jpg" alt="">
                                                </div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('template/'); ?>img/message/4.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Sulaiman din</h2>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('template/'); ?>img/message/3.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Victor Jara</h2>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="message-img">
                                                    <img src="<?php echo base_url('template/'); ?>img/message/2.jpg" alt="">
                                                </div>
                                                <div class="message-content">
                                                    <span class="message-date">16 Sept</span>
                                                    <h2>Victor Jara</h2>
                            ...
                            <li class="nav-item">
                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                    ...
                                    <span class="admin-name"><?php echo $this->session->userdata('userlogin')['nama'] ?></span>
                                ...
                                <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated flipInX">
                                    ...
                                    <li><a href="<?php echo base_url('Logout') ?>"><span class="adminpro-icon adminpro-locked author-log-ic"></span>Log Out</a>
                                    </li>
                                </ul>
                            </li>
                        </ul>
