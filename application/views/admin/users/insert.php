                                    ...
                                    <div class="all-form-element-inner">
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="telepon" value="<?php echo set_value('telepon') ?>" />
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9 text-left">
                                                    <input type="text" class="form-control" name="repassword" value="<?php echo set_value('repassword') ?>" />
                                                    ...
                                                    <div class="form-select-list">
                                                        <select class="form-control custom-select-value" name="level">
                                                            <?php if (user_allow([1], false)) : ?>
                                                                <option value="1" <?php echo set_value('level') == '1' ? 'selected' : ''  ?>>Administration</option>
                                                            <?php endif ?>
                                        ...
                                        <div class="form-group-inner">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                                                    <label class="login2 pull-right pull-right-pro">Gambar</label> </div>
