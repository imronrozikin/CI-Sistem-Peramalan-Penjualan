                            ...
                            <div class="col-lg-12">
                                <div class="all-form-element-inner">
                                    ...
                                    <div class="form-group-inner">
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <label class="login2 pull-right pull-right-pro">Costumer</label>
                                            </div>
                                            <div class="col-lg-9 text-left">
                                            <input type="text" name="customer" class="form-control" list="customer">
                                                    <datalist id="customer">
                                                        <?php foreach ($this->db->group_by('customer')->get('transaksi')->result() as $key => $value) : ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class="login-horizental cancel-wp pull-left">
                                                        ...
                                                        <button id="save" class="btn btn-sm btn-primary login-submit-cs" type="submit">Save Change</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    ...
    var add_produk = () => {
        $.ajax({
            url : "<?php echo base_url("Transaksi/form_insert_produk")?>",
            type : "POST",
            data : {
                id : idx,
            },
