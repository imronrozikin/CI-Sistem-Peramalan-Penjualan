...
class Supplier extends CI_Controller
{
    ...
    public function index()
    {
        $data['users_data'] = $this->db
            ->get_where('users', array('level' => 3 ))
            ->result();
        $this->load->view('admin/users/supplier', $data);
    }
    ...
    public function insert()
    {
        ...
        if ($this->form_validation->run() == false) {
            $this->load->view('admin/users/insert_supplier');
        } else {
           $error = false;
            if ($_FILES['gambar']['name'] != "") {
                ...
                if (!$this->upload->do_upload('gambar')) {
                    ...
                    $this->load->view('admin/users/insert_supplier', $data);
                    $error = true;
                } else {
